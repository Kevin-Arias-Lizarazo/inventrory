...
public class ProveedorControlador {
	...
	private final ProveedorCasoDeUso servicio;

	public ProveedorControlador(ProveedorCasoDeUso servicio) {
	...
	@GetMapping("/paginado")
	public ResponseEntity<PaginaResultado<Proveedor>> listarPagina(
	...
	public ResponseEntity<Proveedor> crear(@RequestBody Proveedor proveedor) {
		return ResponseEntity.status(HttpStatus.CREATED).body(servicio.crear(proveedor));
	}
